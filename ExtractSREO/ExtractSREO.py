...
def fillTemplate(sreoDataFrame):
	...
	for dataColumn in sreoDataFrame.columns:
		...
		relevantCategory = testInput(True, modelName, myString, NO_PRINT)
...
# Return: fillTemplate(extractSREO
# (sreoFilePath)) (.xlsx) --> contains the populated SREO standard template
...
######################## For Testing #################################
FILES = ["SREOs/2022 Lawrence S Connor REO Schedule.xlsx", "SREOs/AP - REO excel 202112.xlsx", "SREOs/NorthBridge.xlsx", "SREOs/RPA REO Schedule - 01.31.2022.xlsx", "SREOs/Simpson REO Schedule (12-31-21).xlsx", "SREOs/SREO Export Template v2 - final.xlsx"]
