...
def trainModel(trainColumn, newModel, modelName, trainingFilePath):
	if not newModel:
		loadModel(modelName)
...
def outputConfidence(trainColumn, modelName, textInput, print):
	loadModel(modelName)
	...
	######################################################### Testing Below #########################################################
def testInput(trainColumn, modelName, testString, print):
	loadModel(modelName)
	#Set of numerical labels and their text values
	if trainColumn:
		labels = COLUMN_LABELS
